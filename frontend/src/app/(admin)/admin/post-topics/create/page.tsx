...
export default function CreatePostTopicPage() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 lg:p-6 rounded-[1.5rem] shadow-sm border border-slate-200">
         <div className="flex items-center gap-4">
           ...
           <div>
             ...
             <p className="text-sm font-medium text-slate-500 mt-0.5">Tạo danh mục để phân loại bài viết blog</p>
           </div>
         </div>
         <button
           onClick={handleSubmit}
           disabled={saving}
           className="flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3.5 sm:py-3 bg-[#ed2a2a] text-white rounded-xl text-sm font-bold shadow-[0_4px_20px_rgba(237,42,42,0.3)] transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-70 disabled:pointer-events-none"
         >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
         ...
         <div className="bg-white rounded-[1.5rem] shadow-sm border border-slate-200 p-6 lg:p-8">
            <h2 className="text-lg font-black text-slate-800 mb-6 flex items-center gap-2">
               <div className="w-8 h-8 rounded-lg bg-red-50 text-[#ed2a2a] flex items-center justify-center">
            ...
            <div className="space-y-6">
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <input
                        ...
                        className="w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl font-medium focus:ring-4 focus:ring-red-50 focus:border-red-400 transition-all text-slate-800"
                        required
                     />
                  </div>
               </div>
               ...
               <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700">Đường Dẫn (URL Slug) <span className="text-slate-400 font-normal ml-1">- Không bắt buộc, tự động tạo nếu để trống</span></label>
                  <div className="relative">
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <textarea
                        ...
                        className="w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl font-medium focus:ring-4 focus:ring-red-50 focus:border-red-400 transition-all min-h-[100px] text-slate-800"
                     />
                  </div>
               </div>
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     ...
                     <select
                        ...
                        onChange={handleChange}
                        className="w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl font-bold focus:ring-4 focus:ring-red-50 focus:border-red-400 transition-all appearance-none bg-white text-slate-800"
                     >
            ...
            <div className="space-y-6">
               ...
               <div className="space-y-2">
                  ...
                  <textarea
                     ...
                     className="w-full p-4 border border-slate-200 rounded-xl font-medium focus:ring-4 focus:ring-blue-50 focus:border-blue-400 transition-all min-h-[120px] text-slate-800"
                  />
               </div>
            </div>
         </div>
