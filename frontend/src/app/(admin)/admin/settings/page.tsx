...
const FIELDS: Record<TabId, { key: string; label: string; type: 'text' | 'textarea' | 'file'; placeholder: string; icon?: any }[]> = {
  ...
  contact: [
    ...
    { key: 'store_latitude',    label: 'Vĩ độ quán (GPS)',        type: 'text',     placeholder: '10.776889',                  icon: MapPin },
    { key: 'store_longitude',   label: 'Kinh độ quán (GPS)',      type: 'text',     placeholder: '106.700806',                 icon: MapPin },
    { key: 'delivery_radius_km',label: 'Bán kính giao hàng (km)', type: 'text',     placeholder: '25',                         icon: MapPin },
    { key: 'delivery_min_order_amount', label: 'Đơn giao hàng tối thiểu (₫)', type: 'text', placeholder: '100000', icon: MapPin },
