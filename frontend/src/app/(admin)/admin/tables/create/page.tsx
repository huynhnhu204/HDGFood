  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      ...
      <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-xl border border-slate-200 p-5 lg:p-6 rounded-[2rem] shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mt-0.5">Khởi tạo bàn mới cho layout nhà hàng</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-[2.5rem] p-6 lg:p-10 border border-slate-200 shadow-sm space-y-10">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-widest ml-1">Định danh Bàn (VD: Bàn 01, VIP 1)</label>
        ...
        {/* Tips Section */}
        <div className="pt-6 border-t border-slate-100 flex items-start gap-5">
           <div className="w-12 h-12 rounded-2xl bg-blue-50 text-blue-500 flex items-center justify-center shrink-0">
              <Info className="w-6 h-6" />
           </div>
           <div>
              <p className="text-[13px] font-black text-slate-700 uppercase tracking-widest mb-1">Cần lưu ý</p>
              <p className="text-[12px] font-medium text-slate-400 leading-relaxed max-w-lg">
                Hệ thống sẽ tự động sinh mã QR cho bàn sau khi khởi tạo thành công. 
                Bạn có thể in mã QR này để khách hàng tự gọi món tại bàn.
              </p>
           </div>
        </div>
      </div>
